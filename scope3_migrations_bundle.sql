-- Scope 3 migrations bundle (generated 2026-07-07).
-- Apply to the shared dev Supabase DB via the SQL Editor. Idempotent /
-- re-runnable. Requires the base schema (organizations, org_members,
-- public.is_org_member) from migrations <=029 to already exist.
-- Files in order: 050-059 then 310-312.
