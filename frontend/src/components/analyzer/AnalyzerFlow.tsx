...
/**
 * The analyzer workflow. Extracted from the /analyzer route so it can be both
 * served at /analyzer and embedded inline on the Portfolio page (the analyzer
 * is folded into Portfolio). Must be rendered within a Suspense boundary
